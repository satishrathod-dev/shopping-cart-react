          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900 truncate">{showNotification.product?.name}</p>
                <p className="text-xs text-green-600">{showNotification.message}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button onClick={handleClose} className="text-xs text-gray-500 hover:text-gray-700 px-2 py-1.5">
                Continue Shopping
              </button>
            </div>
          </div>
